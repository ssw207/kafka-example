...
import com.kafka.exam.consumer.listener.SampleRebalanceListener;
 ...
 */
@Slf4j
public class SampleRebalanceListenerConsumer {
	...
	public static void main(String[] args) {
		...
		consumer.subscribe(Arrays.asList(TOPIC_NAME), new SampleRebalanceListener()); // 리벨런스 리스너 추가
